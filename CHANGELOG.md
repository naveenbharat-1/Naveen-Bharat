# Changelog — Sadguru Coaching Classes
...
- Video player with watermark (Sadguru logo), custom controls, end-screen overlay
...
- Sadguru Sarthi AI chatbot (RAG-powered, Hinglish support)
